                    ...
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          ...
                          <div class="image"> <a href="/viewpackagedetails/{{$package->packagename}}/{{$package->id}}"><img  src="/assets/images/products/p1.jpg" alt=""></a> </div>
                          @else
                          <div class="image"> <a href="/viewpackagedetails/{{$package->packagename}}/{{$package->id}}"><img  src="{{asset('img/packageimage/'.$package->packageimage)}}" alt=""></a> </div>
                          @endif
                          <!-- /.image -->
                        ...
                        <div class="product-info text-left">
                          <h3 class="name"><a href="/viewpackagedetails/{{$package->packagename}}/{{$package->id}}">{{$package->packagename}}</a></h3>
                          <div class=""></div>
                          <div class="description"></div>
                          <div class="product-price"> <span class="price">INR {{$package->packagecost}} </span>  </div>
                          <!-- /.product-price --> 
