...
<form class="form-horizontal" role="form" method="POST" enctype="multipart/form-data" action="/cms/sliders">
{{ csrf_field() }}
	<table class="table table-responsive table-hover table-bordered table-striped" >
		...
		<tr>
			...
			<td><input  class="form-control" name="title" placeholder="Enter Slider Title Here" required></td>
		</tr>
		<tr>
			<td>SLIDER DESCRIPTION<span style="color: red"> *</span></td>
			<td><input  class="form-control" name="description" placeholder="Enter Slider Description Here" required></td>
		</tr>
		...
		<tr>
			<td colspan="4">
				...
				<button class="btn btn-success" style="float: right ;" type="submit">Add Slider</button>
			</td>
		</tr>
